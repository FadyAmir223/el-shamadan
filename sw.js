...
const he = "el-shamadan-static-v19", g = "/el-shamadan", ue = (a, e) => `${g}/locales/${a}/${e}.json`, fe = (a, e) => `${g}/images/${a}/${e}.webp`, de = (a, e) => p.folders.flatMap(
  ...
  ...p.folders.flatMap(
    (a) => p.chars.flatMap(
      (e) => Object.keys(a.key).flatMap((t) => de(a.key[t], e))
    )
  )
