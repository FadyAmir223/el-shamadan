  ...
  return (
    selectedProduct && (
      <article className="overflow-hidden relative py-8 md:py-6 h-[calc(100vh-70px)]">
        <FaAngleLeft
          className="select-none text-4xl cursor-pointer text-yellow hover:text-yellow/80 focus:outline-0  absolute z-20 top-1/4 md:top-1/2 left-0 -translate-y-1/2"
          onClick={() => handlePrevNext('prev')}
        />
        <FaAngleRight
          className="select-none event text-4xl cursor-pointer text-yellow hover:text-yellow/80 focus:outline-0  absolute z-20 top-1/4 md:top-1/2 right-0 -translate-y-1/2 translat"
        ...
        <section className="relative z-10 contain">
          ...
          />
          <p className="max-w-md text-white md:mx-auto md:text-xl rtl:text-2xl">
