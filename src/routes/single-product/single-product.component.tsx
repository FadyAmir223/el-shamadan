  ...
  return (
    selectedProduct && (
      <article className="overflow-hidden relative py-8 md:py-6 h-[calc(100vh-70px)]">
        <FaAngleLeft
          className="text-4xl cursor-pointer text-yellow hover:text-yellow/80 focus:outline-0  absolute z-20 top-1/4 sm:top-1/2 left-0 -translate-y-1/2"
          onClick={() => handlePrevNext('prev')}
        />
        <FaAngleRight
          className="text-4xl cursor-pointer text-yellow hover:text-yellow/80 focus:outline-0  absolute z-20 top-1/4 sm:top-1/2 right-0 -translate-y-1/2 translat"
